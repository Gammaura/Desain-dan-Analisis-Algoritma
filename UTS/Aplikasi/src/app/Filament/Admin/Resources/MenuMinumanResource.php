...
use App\Filament\Admin\Resources\MenuMinumanResource\Pages;
use App\Filament\Admin\Resources\MenuMinumanResource\RelationManagers;
...
class MenuMinumanResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListMenuMinuman::route('/'),
