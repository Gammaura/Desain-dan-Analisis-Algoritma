...
use App\Filament\Admin\Resources\MenuMakananResource\Pages;
use App\Filament\Admin\Resources\MenuMakananResource\RelationManagers;
...
class MenuMakananResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListMenuMakanan::route('/'),
