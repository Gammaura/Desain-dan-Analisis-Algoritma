...
class DataKesehatanPolicy
{
    ...
    {
        return $user->can('view_any_data::kesehatan');
    }
    ...
    {
        return $user->can('view_data::kesehatan');
    }
    ...
    {
        return $user->can('create_data::kesehatan');
    }
    ...
    {
        return $user->can('update_data::kesehatan');
    }
    ...
    {
        return $user->can('delete_data::kesehatan');
    }
    ...
    {
        return $user->can('delete_any_data::kesehatan');
    }
     ...
     */
    public function replicate(User $user, DataKesehatan $dataKesehatan): bool
    {
